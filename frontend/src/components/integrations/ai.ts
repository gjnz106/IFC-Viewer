...
(function () {
  ...
  fab.className = 'aic-fab'; fab.title = 'DQT Assistant';
  ...
  panel.innerHTML = `
    <div class="aic-head">
      <div class="aic-head-logo"></div><b>DQT Assistant</b>
  ...
  async function buildSystem(): Promise<string> {
    ...
    return [
      'Bạn là DQT Assistant — trợ lý xem & truy vấn mô hình IFC trên web cho kỹ sư BIM.',
